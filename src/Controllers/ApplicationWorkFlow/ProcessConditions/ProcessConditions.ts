...
export async function CreateProcessConditions(request, response) {
...
export async function ListProcessConditions(request, response) {
  try {
    const result = await connection.select("*").from(table)
    return response.json(result); 
  } catch (error) {
...
export async function UpdateProcessConditions(request, response) { 
...
export async function DeleteProcessConditions(request, response) { 
